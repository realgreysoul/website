  ...
  return (
    <Layout home>
      ...
      <section className={utilStyles.headingHd}>
        ...
        <p>Если вы хотите написать мне просто так или обратится ко мне по поводу сотрудничества, то напишите, пожалуйста, на эту почту - <a href={`mailto:write@greysoul.ru`}><strong>write@greysoul.ru</strong></a>.</p>
      </section>
    </Layout>
  )
}

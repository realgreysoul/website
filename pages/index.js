  ...
  return (
    <Layout home>
      ...
      <section className={utilStyles.headingHd}>
        ...
        <p>Если вы хотите написать мне по любому поводу <i>(даже за сотрудничеством)</i>, то, пожалуйста, пишите на эту почту - <a href={`mailto:to@greysoul.ru`}><strong>to@greysoul.ru</strong></a>.</p>
      </section>
    </Layout>
  )
}
